...
func (g *GitRepo) IsIgnored(fname string) (bool, error) {
...
func (g *GitRepo) findGitRoot(paths []string) (string, error) {
...
func (g *GitRepo) getGitConfig(key string) (string, error) {
...
func (g *GitRepo) DiffCommits(pretty bool, fromCommit, toCommit string) (string, error) {
	args := []string{"diff"}
...
func (g *GitRepo) GetDirtyFiles() ([]string, error) {
	cmd := exec.Command("git", "status", "--porcelain")
	cmd.Dir = g.root
	output, err := cmd.Output()
	if err != nil {
...
func (g *GitRepo) GetTrackedFiles() ([]string, error) {
	cmd := exec.Command("git", "ls-files")
	cmd.Dir = g.root
	output, err := cmd.Output()
	if err != nil {
...
func (g *GitRepo) IsIgnoredFile(fname string) bool {
